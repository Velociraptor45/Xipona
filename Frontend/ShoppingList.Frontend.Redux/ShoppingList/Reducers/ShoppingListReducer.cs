...
public static class ShoppingListReducer
{
    ...
    [ReducerMethod]
    public static ShoppingListState OnOpenUpdatePrice(ShoppingListState state, OpenUpdatePriceAction action)
    {
        return state with
        {
    ...
    [ReducerMethod(typeof(CloseUpdatePriceAction))]
    public static ShoppingListState OnCloseUpdatePrice(ShoppingListState state)
    {
        return state with
        {
            PriceUpdate = state.PriceUpdate with
    ...
    [ReducerMethod]
    public static ShoppingListState OnPriceOnPriceUpdateChanged(ShoppingListState state,
        PriceOnPriceUpdateChangedAction action)
    {
        return state with
        {
            PriceUpdate = state.PriceUpdate with
    ...
    [ReducerMethod]
    public static ShoppingListState OnUpdatePriceForAllTypesOnPriceUpdateChanged(ShoppingListState state,
        UpdatePriceForAllTypesOnPriceUpdateChangedAction action)
    {
        return state with
        {
            PriceUpdate = state.PriceUpdate with
